...
#    parser.add_argument( '--output_path', type=str, default='output/', help='Path to save the visualization results, e.g., histograms, graph etc.')
    ...
    parser.add_argument( '--annotation_file_path', type=str, default='NEST_figures_input_PDAC/PDAC_64630_annotation.csv', help='Path to load the annotation file in csv format (if available) ')
