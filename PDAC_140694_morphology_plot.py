...
if __name__ == "__main__":
    ...
    parser.add_argument( '--annotation_file_path', type=str, default='NEST_figures_input_PDAC/PDAC_140694_annotation_ayah_morphology.csv', help='Path to load the annotation file in csv format (if available) ') #_ayah_histology
