...
if __name__ == "__main__":
    ...
    parser.add_argument( '--top_edge_count', type=int, default=500,help='Number of the top communications to plot. To plot all insert -1') # 
    ...
    for top_edge_count in [500, 2500, 5000]:
    ...
    #    print(df_column_names)
        ...
        chart.save(output_name + args.data_name +'_Tcell_altair_plot_top'+str(top_edge_count)+'.html')
        ...
        write_dot(g, output_name + args.data_name + "_test_interactive_top"+str(top_edge_count)+".dot")
