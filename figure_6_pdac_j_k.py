...
if __name__ == "__main__":
    ...
    parser.add_argument( '--annotation_file_path', type=str, default='NEST_figures_input/PDAC_140694_annotation.csv', help='Path to load the annotation file in csv format (if available) ') #_ayah_histology
    parser.add_argument( '--selfloop_info_file', type=str, default='NEST_figures_input/PDAC_140694_self_loop_record', help='Path to load the selfloop information file produced during data preprocessing step')
    parser.add_argument( '--top_ccc_file', type=str, default='NEST_figures_input/PDAC_140694_top20percent.csv', help='Path to load the selected top CCC file produced during data postprocessing step')
