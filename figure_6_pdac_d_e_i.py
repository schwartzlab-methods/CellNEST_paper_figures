...
if __name__ == "__main__":
    ...
    parser.add_argument( '--annotation_file_path', type=str, default='NEST_figures_input_PDAC/PDAC_64630_annotation.csv', help='Path to load the annotation file in csv format (if available) ') #_ayah_histology
