...
if __name__ == "__main__":
    ...
    parser.add_argument( '--barcode_info_file', type=str, default='NEST_figures_input/Female_Virgin_Parenting_Excitatory_id24_bregma0.11_barcode_info', help='Path to load the barcode information file produced during data preprocessing step')
    ...
    parser.add_argument( '--selfloop_info_file', type=str, default='NEST_figures_input/Female_Virgin_ParentingExcitatory_self_loop_record', help='Path to load the selfloop information file produced during data preprocessing step')
    parser.add_argument( '--top_ccc_file', type=str, default='NEST_figures_input/Female_Virgin_Parenting_Excitatory_id24_bregma0.11_top20percent.csv', help='Path to load the selected top CCC file produced during data postprocessing step')
