...
if __name__ == "__main__":
    ...
    parser.add_argument( '--data_name', type=str, default='Female_Virgin_Parenting_Excitatory_id24_bregma0.11', help='The name of dataset') # 
    ...
    parser.add_argument( '--barcode_info_file', type=str, default='NEST_figures_input_MERFISH_plot/Female_Virgin_Parenting_Excitatory_id24_bregma0.11_barcode_info', help='Path to load the barcode information file produced during data preprocessing step')
    ...
    parser.add_argument( '--selfloop_info_file', type=str, default='NEST_figures_input_MERFISH_plot/Female_Virgin_ParentingExcitatory_self_loop_record', help='Path to load the selfloop information file produced during data preprocessing step')
    parser.add_argument( '--top_ccc_file', type=str, default='NEST_figures_input_MERFISH_plot/Female_Virgin_Parenting_Excitatory_id24_bregma0.11_top20percent.csv', help='Path to load the selected top CCC file produced during data postprocessing step')
...
#    print(df_column_names)
    ...
    if args.histogram_attention_score==1:
        ...
        for i in range (1, len(csv_record_final)-1):    
            lr_score[csv_record_final[i][2]+'-'+csv_record_final[i][3]].append(csv_record_final[i][5])
    ...
    for k in range (1, len(csv_record_final)-1):
        score_list.append(csv_record_final[k][4]) #8
    ...
    for k in range (1, len(csv_record_final)-1):
        ...
        edge_score = csv_record_final[k][4] #8
