...
if __name__ == "__main__":
    ...
    parser.add_argument( '--annotation_file_path', type=str, default='NEST_figures_input_PDAC/PDAC_64630_annotation_subtype.csv', help='Path to load the annotation file in csv format (if available) ') #_ayah_histology
    ...
    for i in range (0, len(annotation_data)):
        pathologist_label.append([annotation_data['Barcode'][i], annotation_data['Subtype'][i]]) 
    ...
    for i in range (0, len(barcode_info)):        
        ...
        if barcode_type[barcode_info[i][0]]=='Classical A':
            data_list['color'].append("#1C6CAB")
        elif barcode_type[barcode_info[i][0]]=='Classical B':
            data_list['color'].append("#A4C0E5")
        elif barcode_type[barcode_info[i][0]]=='Basal A':
            data_list['color'].append("#814C42")
        elif barcode_type[barcode_info[i][0]]=='Basal B':
            data_list['color'].append("#FF7311")
        else:
            data_list['color'].append("#000000")
    ...
    chart.save(output_name + args.data_name +'_subtype_altair_plot.html')
