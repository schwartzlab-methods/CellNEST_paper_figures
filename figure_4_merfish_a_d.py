...
if __name__ == "__main__":
    ...
    parser.add_argument( '--selfloop_info_file', type=str, default='NEST_figures_input/Female_Parenting_Excitatory_self_loop_record', help='Path to load the selfloop information file produced during data preprocessing step')
