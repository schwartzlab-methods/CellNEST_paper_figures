...
if __name__ == "__main__":
    ...
    parser.add_argument( '--annotation_file_path', type=str, default='NEST_figures_input/PDAC_64630_annotation_subtype.csv', help='Path to load the annotation file in csv format (if available) ') #_ayah_histology
